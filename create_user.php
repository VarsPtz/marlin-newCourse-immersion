...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
          ...
          ?>
        <form action="page_create_user_handler.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="user_email">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_vk">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_telegram">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_instagram">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button class="btn btn-success" name="btn-create-user">Добавить</button>
                                    </div>
                                </div>
                            </div>
                        </div>
