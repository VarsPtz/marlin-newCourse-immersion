                          ...
                          <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                              <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                ...
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/avatars/<?php echo $user['user_avatar'];?>'); background-size: cover;"></span>
                                </span>
                                      <div class="info-card-text flex-1">
                                          <a href="<?php echo 'edit.php?id='.$user["id"];?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                          ...
                                          <div class="dropdown-menu">
                                              ...
                                              <a href="page_delete_handler.php?id=<?php echo $user['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                                  <i class="fa fa-window-close"></i>
                                                  Удалить
                                              </a>
                                          </div>
                                          <span class="text-truncate text-truncate-xl"><?php echo $user["user_job"].', '.$user["user_address"];?></span>
                                      </div>
                              ...
                              <div class="card-body p-0 collapse show">
                                  <div class="p-3">
                                      <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                          <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $user["user_phone"];?></a>
                                      ...
                                      <div class="d-flex flex-row">
                                          <a href="<?php echo $user['user_vk'];?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                              <i class="fab fa-vk"></i>
                                          </a>
                                          <a href="<?php echo $user['user_telegram'];?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                              <i class="fab fa-telegram"></i>
                                          </a>
                                          <a href="<?php echo $user['user_instagram'];?>" class="mr-2 fs-xxl" style="color:#E1306C">
